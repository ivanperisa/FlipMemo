...
const AnimatedSendButton = forwardRef<AnimatedSendButtonRef, AnimatedSendButtonProps>(({
                                                                                           onSuccess,
                                                                                           sendText = "SEND",
                                                                                           successText = "SUCCESS",
                                                                                           className = "",
        ...
        >
            ...
            <span
                className={`
                    block
                    transition-all
                    ${isActive ? 'scale-0 -translate-y-[350%] opacity-0' : 'scale-100 translate-y-0 opacity-100'}
                `}
                style={{
